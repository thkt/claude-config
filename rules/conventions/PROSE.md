...
| Measurement provenance | It goes stale without changing behavior. Recording where a number came from or what was measured falls under this. A number that carries a rejection is not this: keep the measurement a discarded option was ruled out on |
