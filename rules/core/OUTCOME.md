...
Behavior follows ~/.claude/rules/conventions/PROSE.md strictly. The project's reason for being and Indicators are optional, and aspirational vague terms are permitted only in these two.
