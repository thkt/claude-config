...
Issue #286 は `/qualify` の実運用フィードバックを記録する。2026-07-29 に Nikkei/ise-pl-app の issue #2325 で「まだ任せっきりにやると場当たり的な対応をして fat になるので、根本原因を詰めてから qualify かけ直して要件を詰めるってことをしました」という指摘が出た。原因が未確定のまま案を並べると、症状に効くだけの対処が案として通ってしまう。
