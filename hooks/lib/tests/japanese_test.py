...
class CharacterClass(unittest.TestCase):
    def test_each_script_counts(self):
        self.assertTrue(has_japanese("ひらがな" + "カタカナ" + "漢字" + "ー", 1))

    def test_punctuation_alone_is_not_prose(self):
    ...
    def test_english_and_digits_do_not_count(self):
