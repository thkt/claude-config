...
3. Run each Behavior through `rules/core/OUTCOME.md` § Outcome test; rewrite failures and re-present to the user
...
3. Run each changed Behavior through `rules/core/OUTCOME.md` § Outcome test, then Edit
