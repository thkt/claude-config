...
Every judgment below is decided by the table.

| Subject               | Condition                                                        | Treatment                                                                                                 |
| --------------------- | ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| A question            | Evidence settles it to one answer                                | A fact. subagents check it in parallel                                                                    |
| A question            | It needs a choice, such as priority, scope, or trade-offs        | A preference. Send it unverified to the unsettled pile                                                    |
| A verified fact       | The targeted state already holds, or it contradicts the proposal | The core is overturned. Skip Phase 2 and put the grounds in the Why. Do not stop on advisor opinion alone |
| A verified fact       | It conflicts with only a sub-claim                               | Proceed on the surviving part                                                                             |
| An unsettled question | It is irreversible or high-impact                                | Ask it via AskUserQuestion. Cap 7 questions                                                               |
| An unsettled question | Anything else                                                    | Proceed on the advisor hypothesis as an assumption, and keep them all in the Why                          |
...
2. List the open questions in the proposal and sort them by the table. Do not sort by advisor confidence
