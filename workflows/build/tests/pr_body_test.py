...
class RenderTest(unittest.TestCase):
    ...
    def test_leads_with_auto_generated_label(self):
        ...
        # is machine-generated, not hand-written by the author, and what the visible
        # status line is for (deciding whether to open the fold).
        body = pr_body.render(FULL)
        self.assertIn(
            "_A verification record auto-generated by the build workflow. "
            "It carries no deep review. The status line below tells you whether "
            "to open it._",
            body,
        )
    ...
    def test_no_command_invitation_is_printed(self):
        ...
        for payload in (FULL, CLEAN):
            ...
            self.assertIn("carries no deep review", body)
    ...
    def test_japanese_translates_prose_labels_but_keeps_github_keyword(self):
        ...
        self.assertIn("Closes #123", body)
        self.assertIn("_build workflow が自動生成した検証記録。", body)
        ...
        self.assertIn("深いレビューは含まない", body)
