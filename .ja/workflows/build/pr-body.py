...
LABELS = {
    "english": {
        "tail_header": "_A verification record auto-generated by the build workflow. It carries no deep review. The status line below tells you whether to open it._",
    ...
    "japanese": {
        "tail_header": "_build workflow が自動生成した検証記録。深いレビューは含まない。開くかは下の status 行で判断する。_",
