...
| 対象         | 条件                                             | 満たす                                                                                    | 満たさない                                                     |
| ------------ | ------------------------------------------------ | ----------------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| 論点         | 証拠で答えが 1 つに決まる                        | 事実の論点。subagent が並列で答えを確かめる                                               | 判断の論点。優先順位やスコープなど選択が要るもので、未決へ回す |
| 確かめた事実 | 狙う状態が既に成立している、または提案と矛盾する | 提案が成り立たない。Phase 2 を飛ばし、根拠を Why に据える。advisor の見解だけでは止めない | 食い違わなかった主張で続ける                                   |
...
5. 確かめた事実を表に当てる。提案が成り立たなければ Phase 2 を飛ばす
