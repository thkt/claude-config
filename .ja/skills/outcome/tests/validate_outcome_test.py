...
class ValidateOutcome(unittest.TestCase):
    ...
    def test_filled_file_routes_to_update(self):
    ...
    def test_absent_file_routes_to_generate(self):
    ...
    def test_tbd_behavior_routes_to_generate(self):
    ...
    def test_filled_behavior_with_tbd_elsewhere_routes_to_update(self):
    ...
    def test_surviving_placeholder_is_an_error(self):
        body = FILLED.replace(
            "- A reviewer reads the diff without asking what the change is for.",
    ...
    def test_inline_braces_in_prose_are_not_placeholders(self):
    ...
    def test_unfilled_indicator_cell_is_a_placeholder(self):
    ...
    def test_omitted_indicators_draws_no_warning(self):
        body = (
            "# OUTCOME\n\n## Outcome state\n\n### Behavior\n\n- A user sees the total.\n\n"
            "## Non-goals\n\n- None.\n\n## Constraints\n\n- None.\n"
        )
